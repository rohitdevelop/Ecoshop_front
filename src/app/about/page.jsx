...
const AboutPage = () => {
  ...
  const features = [
    {
      ...
      description: "All our products are biodegradable, sustainable, or made from recycled materials with zero harmful chemicals.",
      color: "green"
    },
    {
      icon: <Recycle className="w-8 h-8" />,
      title: "Sustainable Packaging",
      description: "We use plastic-free, recyclable, and compostable packaging for all deliveries. Zero waste approach.",
      color: "blue"
    },
    {
      icon: <Handshake className="w-8 h-8" />,
      title: "Community Driven",
      description: "We support local artisans, fair trade practices, and eco-conscious businesses worldwide.",
      color: "purple"
    }
  ];
  ...
  const stats = [
    ...
    { number: "500+", label: "Eco Products", icon: <Leaf className="w-6 h-6" /> },
    { number: "50+", label: "Partner Brands", icon: <Handshake className="w-6 h-6" /> },
  ...
  const values = [
    {
      ...
      title: "Our Vision",
      description: "To create a world where sustainable living is accessible, affordable, and the preferred choice for everyone."
    },
    {
      icon: <Target className="w-12 h-12" />,
      title: "Our Mission",
      description: "Providing high-quality, eco-friendly products that reduce environmental impact while enhancing everyday life."
    },
    {
      icon: <Heart className="w-12 h-12" />,
      title: "Our Values",
      description: "Sustainability, transparency, quality, and community. We believe in doing business responsibly."
    }
  ];
  ...
  const timeline = [
    {
      ...
      description: "Started with a vision to make sustainable products accessible to everyone."
    },
    {
      year: "2021",
      title: "First 1000 Customers",
      description: "Reached our first milestone with overwhelming support from eco-conscious consumers."
    },
    {
      year: "2022",
      title: "Carbon Neutral Achievement",
      description: "Became a fully carbon-neutral company through renewable energy and offset programs."
    },
    {
      year: "2023",
      title: "Global Expansion",
      description: "Expanded to serve customers worldwide while maintaining our sustainability standards."
    },
    {
      year: "2024",
      title: "Award Recognition",
      description: "Received multiple sustainability awards and certifications for our environmental impact."
    }
  ];
        ...
        >
          <div className={`transition-all duration-1000 ${isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
              Your trusted destination for eco-friendly and sustainable products that make a difference for our planet.
            </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div 
            ...
            data-animate
          >
            <div className={`transition-all duration-1000 delay-200 ${isVisible['who-we-are'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              <div className="mb-6">
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                At EcoShop, we believe in a greener future. Our mission is to offer sustainable alternatives that reduce waste, protect the environment, and improve everyday living for millions of people worldwide.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Founded by a team of environmental enthusiasts and business leaders, we're committed to making sustainable living accessible, affordable, and enjoyable for everyone.
              </p>
            ...
            <div className={`transition-all duration-1000 delay-400 ${isVisible['who-we-are'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built on strong values and a clear vision for a sustainable future
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're more than just an eco-friendly store. We're your partner in sustainable living.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex justify-center mb-6">
                    <div className={`bg-${feature.color}-100 group-hover:bg-${feature.color}-200 p-4 rounded-full transition-all duration-300 group-hover:scale-110`}>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90 leading-relaxed">
            Join thousands of customers who have already made the switch to sustainable living. 
