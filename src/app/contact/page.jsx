      ...
      <section className="relative bg-gradient-to-br from-green-50 via-green-100 to-emerald-100 pt-24 pb-16 px-4 overflow-hidden mt-16">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
            We'd love to hear from you! Whether you have questions, feedback, or need support with your eco-friendly journey.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactMethods.map((method, index) => (
              ...
              >
                <div className={`bg-${method.color}-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
              ...
              <div className="bg-green-50 p-8 rounded-2xl h-full">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">EcoShop Headquarters</p>
                      <p className="text-gray-600">123 Eco Street, Green City</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">visit@ecoshop.com</p>
                    </div>
                  </div>
                </div>
